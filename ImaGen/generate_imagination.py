...
vq_parser.add_argument("--num_texts", type=int, help="Number of consecutive texts from which imagination images are generated", default=None)
vq_parser.add_argument("--start_idx", type=int, help="The index of the first text", default=1)
...
if __name__ == '__main__':
    ...
    for idx, line in enumerate(dev_list):
        if args.num_texts is not None and idx >= (args.start_idx + args.num_texts):
            break
